...
#define PLAYER_SPEED				0.08f				// 풀레이어의 이동속도
...
HRESULT Render( void )
{
    ...
    g_pImmediateContext->OMSetBlendState( g_pbsAddBlend, NULL, 0xFFFFFFFF );	// 가산 블렌딩
