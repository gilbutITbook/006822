...
#define BILLBOARD_SIZE				4.0f				// 빌보드 크기
...
HRESULT Render( void )
{
	...
	// 빌보드
    g_pImmediateContext->OMSetBlendState( g_pbsAddBlend, NULL, 0xFFFFFFFF );	// 가산블렌드
