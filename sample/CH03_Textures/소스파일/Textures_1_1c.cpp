...
#define SCALE_SPEED			0.02f				// 텍스처 변화 속도
...
XMMATRIX CreateWorldMatrix( void )						// 월드행렬 생성
{
	float		fAngle;
...
int DrawChangingPictures( void )						// 이미지 그리기
{
	CUSTOMVERTEX			Vertices[4];
	WORD					wIndices[6] = { 0, 1, 2,
											2, 1, 3, };	// 인덱스 데이터
	static float			fTexScale_x = 0.0f;	// 텍스처 좌표 크기
	static float			fTexScale_y = 0.0f;	// 텍스처 좌표 크기
...
int InitDrawModes( void )
{
	...
	float v4Color[4] = { 1.0f, 0.0f, 0.0f, 0.0f };			// 보더컬러
