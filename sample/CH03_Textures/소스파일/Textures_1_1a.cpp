...
#define SCALE_SPEED			0.05f				// 텍스처 좌표변화 속도
...
int DrawChangingPictures( void )						// 그리기
{
	...
	WORD					wIndices[6] = { 0, 1, 2,
											2, 1, 3, };	//  인덱스 데이터
	static float			fTexScale_x = 1.0f;	// 텍스처 좌표 크기
	static float			fTexScale_y = 1.0f;	// 텍스처 좌표 크기
...
#include <stdio.h>
#include <windows.h>
#include <tchar.h>								// Unicode, 멀티바이트 문자관련
