...
{
	static float	fAngleY = 0.0f;						// x축 중심 회전각
...
{
	int					i, j;
	CUSTOMVERTEX		Vertices[2 * ( CORNER_NUM + 1 )];	// 정점 데이터
	WORD				wIndices[CORNER_NUM * 2 * 3];	// 인덱스 데이터
	float				fTheta;
	float				fAngleDelta;
	int					nIndex;						// 데이터의 인덱스
	float				vs;
