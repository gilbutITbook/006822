...
#define WEIGHT_NUM					11					// 추의 수
#define CENTER_HEIGHT				2.0f				// 중립점 높이
#define SPRING_K					0.001f				// 스프링 상수
#define SPRING_K2					0.003f				// 추간 스프링 상수
...
int Cleanup( void )
{
    ...
    SAFE_RELEASE( g_pImmediateContext );					// 디바이스 컨덱스트
