...
#define HEIGHT_NUM				11								// 높이 데이터 수
#define BLOCK_NUM				( HEIGHT_NUM - 1 )				// 지형블록 수
...
//    g_pImmediateContext->RSSetState( g_pRS_Cull_CW );				// 컬링
    g_pImmediateContext->RSSetState( g_pRS );				// 컬링
