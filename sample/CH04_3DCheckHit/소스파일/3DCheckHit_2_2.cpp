...
#define CHECK_TRIANGLE_NUM			3					// 충돌판정삼각형수
#define GROUND_SIZE					20.0f				// 그라운드 크기 
...
XMFLOAT3 Subtract( XMFLOAT3 *pv3Vec1, XMFLOAT3 *pv3Vec2 )						// 벡터의 뺄샘
{
...
int MakeSphereIndexed( float x, float y, float z, float r,
					   ...
					   int nIndexOffset )			// 구 작성(중심위치와 인덱스)
{
	int					i, j;
	float				fTheta;
	float				fPhi;
